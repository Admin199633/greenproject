      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex gap-2 shrink-0">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-md text-sm font-medium h-9 px-4 border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 transition-colors"
          >
            ייצוא CSV
          </Link>
          <Link
            href="/documents/new"
            className="inline-flex items-center justify-center rounded-md text-sm font-medium h-9 px-4 bg-brand-600 text-white hover:bg-brand-700 transition-colors"
          >
            + מסמך חדש
          </Link>
        </div>
